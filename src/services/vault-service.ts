...
// TODO Temporary type for codereview
type TTuple = {}
...
export class VaultService {
  ...
  // TODO args are BigNumber (all uint256)?
  public async getComputeApr(address: string, tvl: BigNumber, rewards: BigNumber, duration: BigNumber): Promise<BigNumber> {
    return this.tetuApi.web3Call3(this.instance(address).computeApr, tvl, rewards, duration, address + ' computeApr');
  }

  public async getComputeRewardApr(address: string, vault: string, rt: string): Promise<BigNumber> {
  ...
  public async getIsController(address: string, adr: string): Promise<boolean> {
    return this.tetuApi.web3Call1(this.instance(address).isController, adr, address + ' isController');
  }

  public async getIsGovernance(address: string, adr: string): Promise<boolean> {
  ...
  public async getStrategyPlatform(address: string, strategy: string): Promise<BigNumber> {
  ...
  public async getUserInfo(address: string, user: string, vault: string): Promise<BigNumber> {
    return this.tetuApi.web3Call2(this.instance(address).userInfo, user, vault, address + ' userInfo');
  }

  public async getUserInfoLight(address: string, user: string, vault: string): Promise<BigNumber> {
  ...
  // TODO => tuple?
  public async getVaultInfo(address: string, vault: string): Promise<TTuple> {
    return this.tetuApi.web3Call1(this.instance(address).vaultInfo, vault, address + ' vaultInfo');
  }

  // TODO => tuple?
  public async getVaultInfoLight(address: string, vault: string): Promise<TTuple> {
    return this.tetuApi.web3Call1(this.instance(address).vaultInfoLight, vault, address + ' vaultInfoLight');
  }
  
  // TODO => tuple[]?
  public async getVaultInfos(address: string, vaults: string[]): Promise<TTuple[]> {
    return this.tetuApi.web3Call1(this.instance(address).vaultInfos, vaults, address + ' vaultInfos');
  }

  // TODO => tuple[]?
  public async getVaultInfosLight(address: string, vaults: string[]): Promise<TTuple[]> {
  ...
  // TODO => tuple[]?
  public async getVaultWithUserInfoPages(address: string, user: string, page: BigNumber, pageSize: BigNumber): Promise<TTuple[]> {
  ...
  // TODO => tuple[]?
  public async getVaultWithUserInfoPagesLight(address: string, user: string, page: BigNumber, pageSize: BigNumber): Promise<TTuple[]> {
  ...
  // TODO => tuple[]?
  public async getVaultWithUserInfos(address: string, user: string, vaults: string[]): Promise<TTuple[]> {
    return this.tetuApi.web3Call2(this.instance(address).vaultWithUserInfos, user, vaults, address + ' vaultWithUserInfos');
  }

  // TODO => tuple[]?
  public async getVaultWithUserInfosLight(address: string, user: string, vaults: string[]): Promise<TTuple[]> {
