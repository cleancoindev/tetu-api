...
interface SmartVaultInterface extends ethers.utils.Interface {
  functions: {
...
export class SmartVault extends BaseContract {
  ...
  functions: {
    ...
    userBoostTs(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
