...
import type { ISmartVault, ISmartVaultInterface } from "../ISmartVault";
...
export class ISmartVault__factory {
  static readonly abi = _abi;
  static createInterface(): ISmartVaultInterface {
    return new utils.Interface(_abi) as ISmartVaultInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ISmartVault {
    return new Contract(address, _abi, signerOrProvider) as ISmartVault;
  }
}
