...
import type {
  ...
  SNXStrategyFullBuybackInterface,
} from "../SNXStrategyFullBuyback";
...
export class SNXStrategyFullBuyback__factory {
  static readonly abi = _abi;
  static createInterface(): SNXStrategyFullBuybackInterface {
    return new utils.Interface(_abi) as SNXStrategyFullBuybackInterface;
  }
  static connect(
    address: string,
