...
import type {
  ...
  MCv2StrategyFullBuybackInterface,
} from "../MCv2StrategyFullBuyback";
...
const _abi = [
  ...
  {
    inputs: [],
    name: "computeMaticWeeklyPoolReward",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  {
    inputs: [],
    name: "computeSushiWeeklyPoolReward",
    outputs: [
      {
        internalType: "uint256",
        name: "",
...
export class MCv2StrategyFullBuyback__factory {
  static readonly abi = _abi;
  static createInterface(): MCv2StrategyFullBuybackInterface {
    return new utils.Interface(_abi) as MCv2StrategyFullBuybackInterface;
  }
  static connect(
    address: string,
