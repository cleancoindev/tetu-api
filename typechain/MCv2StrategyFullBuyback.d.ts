...
interface MCv2StrategyFullBuybackInterface extends ethers.utils.Interface {
  functions: {
...
export class MCv2StrategyFullBuyback extends BaseContract {
  ...
  interface: MCv2StrategyFullBuybackInterface;
