...
interface MockStrategySelfFarmInterface extends ethers.utils.Interface {
  functions: {
    "STRATEGY_TYPE()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "STRATEGY_TYPE",
    values?: undefined
  ): string;
...
export class MockStrategySelfFarm extends BaseContract {
  ...
  interface: MockStrategySelfFarmInterface;

  functions: {
    STRATEGY_TYPE(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    STRATEGY_TYPE(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    STRATEGY_TYPE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
