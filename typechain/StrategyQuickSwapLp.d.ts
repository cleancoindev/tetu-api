...
interface StrategyQuickSwapLpInterface extends ethers.utils.Interface {
  functions: {
...
export class StrategyQuickSwapLp extends BaseContract {
  ...
  interface: StrategyQuickSwapLpInterface;
