...
interface SNXStrategyFullBuybackInterface extends ethers.utils.Interface {
  functions: {
...
export class SNXStrategyFullBuyback extends BaseContract {
  ...
  interface: SNXStrategyFullBuybackInterface;
