...
interface VaultStorageV100Interface extends ethers.utils.Interface {
  functions: {
...
export class VaultStorageV100 extends BaseContract {
  ...
  interface: VaultStorageV100Interface;
