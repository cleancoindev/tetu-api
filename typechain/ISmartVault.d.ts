...
interface ISmartVaultInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "userBoostTs", values: [string]): string;
  encodeFunctionData(
...
export class ISmartVault extends BaseContract {
  ...
  interface: ISmartVaultInterface;
  ...
  callStatic: {
    ...
    userBoostTs(_user: string, overrides?: CallOverrides): Promise<BigNumber>;
