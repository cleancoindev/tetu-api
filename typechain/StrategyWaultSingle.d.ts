...
interface StrategyWaultSingleInterface extends ethers.utils.Interface {
  functions: {
    "STRATEGY_NAME()": FunctionFragment;
    "VERSION()": FunctionFragment;
    "WEX_POLY_MASTER()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "WEX_POLY_MASTER",
    values?: undefined
  ): string;
...
export class StrategyWaultSingle extends BaseContract {
  ...
  interface: StrategyWaultSingleInterface;
  ...
  functions: {
    ...
    WEX_POLY_MASTER(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    WEX_POLY_MASTER(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    WEX_POLY_MASTER(overrides?: CallOverrides): Promise<PopulatedTransaction>;
